...
const BusinessIntelligence = () => {
  ...
  // Display top selling items - mapper function - data coming from Backend
  ...
  // Display top selling items quantity - mapper function - data coming from Backend
  ...
  const pie = {
    // Hardcoding labels for the demo (time constraint), will implement the feature after the demo-day
